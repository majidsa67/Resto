...
@section('content')
    ...
    <div class="boxed-page">
        <nav id="navbar-header" class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand navbar-brand-center d-flex align-items-center p-0 only-mobile" href="/">
                    <img src="/Resto/assets/img/logo.png" alt="">
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                    ...
                    <a class="navbar-brand navbar-brand-center d-flex align-items-center only-desktop" href="#">
                        <img src="/Resto/assets//Resto/assets//Resto/assets//Resto/assets/img/logo.png" alt="">
                    </a>
                    <ul class="navbar-nav d-flex justify-content-between">
                        <div class="d-flex flex-lg-row flex-column">
                            <li class="nav-item active">
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-lg-6 hero-right">
                        <div class="owl-carousel owl-theme hero-carousel">
                            <div class="item">
                                <img class="img-fluid" src="/Resto/assets/img/hero-1.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-fluid" src="/Resto/assets/img/hero-2.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-fluid" src="/Resto/assets/img/hero-3.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="gtco-welcome" class="bg-white section-padding">
            <div class="container">
                <div class="section-content">
                    <div class="row">
                        <div class="col-sm-5 img-bg d-flex shadow align-items-center justify-content-center justify-content-md-end img-2" style="background-image: url(/Resto/assets/img/hero-2.jpg);">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#" class="thumb-menu">
                                            <img class="img-fluid img-cover" src="/Resto/assets/img/hero-1.jpg" />
                ...
                <span class="subheading">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center mt-4 mt-md-0">
                            <img src="/Resto/assets/img/steak.jpg" alt="" class="img-fluid shadow w-100">
                        </div>
                    </div>
                    <div class="row mt-5">
                        <div class="col-lg-5 col-md-6 align-self-center order-2 order-md-1 mt-4 mt-md-0">
                            <img src="/Resto/assets/img/salmon-zucchini.jpg" alt="" class="img-fluid shadow w-100">
                        </div>
                        ...
                        <div class="col-lg-4 menu-wrap">
                            ...
                            <div class="menus d-flex align-items-center">
                                <div class="menu-img rounded-circle">
                                    <img class="img-fluid" src="/Resto/assets/img/breakfast-1.jpg" alt="">
                                </div>
                                <div class="text-wrap">
        ...
        <section id="gtco-testimonial" class="overlay bg-fixed section-padding" style="background-image: url(/Resto/assets/img/testi-bg.jpg);">
            <div class="container">
                <div class="section-content">
                    <div class="heading-section text-center">
                <span class="subheading">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="team-card mb-5">
                                <img class="img-fluid" src="/Resto/assets/img/chef-1.jpg" alt="">
                                <div class="team-desc">
                        ...
                        <div class="col-md-4">
                            <div class="team-card mb-5">
                                <img class="img-fluid" src="/Resto/assets/img/chef-2.jpg" alt="">
                                <div class="team-desc">
                        ...
                        <div class="col-md-4">
                            <div class="team-card mb-5">
                                <img class="img-fluid" src="/Resto/assets/img/chef-3.jpg" alt="">
                                <div class="team-desc">
